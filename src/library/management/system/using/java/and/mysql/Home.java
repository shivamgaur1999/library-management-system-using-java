...
public class Home extends JFrame implements ActionListener {
	...
	public Home() {
		...
		menuBar.setBounds(720, 10, 50, 30);
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/second.jpg"));
		...
		b6 = new JButton("Student details ");
		b6.addActionListener(this);
		b6.setBackground(Color.BLACK);
		b6.setForeground(Color.WHITE);
		b6.setBounds(562, 620, 167, 44);
		contentPane.add(b6);
		...
		ImageIcon i17 = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/9.png"));
		Image i18 = i17.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
		ImageIcon i19 = new ImageIcon(i18);
		l6 = new JLabel(i19);
		l6.setBounds(562, 440, 139, 152);
		contentPane.add(l6);
